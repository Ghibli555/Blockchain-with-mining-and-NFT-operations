...
#The secret_key_sender_str and public_key_receiver_str need to be replaced your encoded secret key and receiver's public key respectively.
...
# The xxx.xxx.xxx.xxx should be replaced with the actual IP address of the server.
